...
Open **http://localhost:5173** (React dev) or **http://localhost:3000** (Docker `dashboard-web`) — **General Overview** and **Velocity Deep-Dive**. Data reloads automatically when Airflow rebuilds marts; use **Reload data** in the sidebar for an immediate refresh.
