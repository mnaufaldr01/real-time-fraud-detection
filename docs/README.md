...
| Doc | Contents |
| --- | -------- |
| [setup.md](setup.md) | Prerequisites, virtualenvs, quick start, service URLs, common commands |
| [scoring.md](scoring.md) | Multi-tier cascade, rules, ML, anomaly, flag reasons, env vars |
| [analytics.md](analytics.md) | dbt marts, dashboard KPIs, Airflow refresh |
