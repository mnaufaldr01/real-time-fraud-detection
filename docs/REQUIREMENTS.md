...
| FR-5 | Composite score: 60% rules + 40% anomaly | Implemented |
| FR-6 | Hard-decline rules bypass score threshold | Implemented |
...
| FR-10 | Synthetic generator with ~3% fraud injection | Implemented |
